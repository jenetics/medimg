 ...
 * @version 0.1
 */
public class RegistrationWizard extends Wizard implements Observer, ReaderThreadListener, WriterThreadListener, RegistrationListener {
    ...
    */
    ...
    public void registrationStarted(RegistrationEvent event) {
        ...
        imageViewer = new TwinImageViewer("Koregistriervorgang", imageData1, imageData2);
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        pcaRegKindRadioButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
        ...
        otherRegKindRadioButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    private void targetImageDataSearchButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_targetImageDataSearchButtonActionPerformed
    ...
    private void regStartButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_regStartButtonActionPerformed
        // Add your handling code here:
    ...
    private void otherRegKindRadioButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_otherRegKindRadioButtonActionPerformed
        // Add your handling code here:
    ...
    private void pcaRegKindRadioButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pcaRegKindRadioButtonActionPerformed
        // Add your handling code here:
    ...
    private void sourceImageDataSearchButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sourceImageDataSearchButtonActionPerformed
        // Add your handling code here:
