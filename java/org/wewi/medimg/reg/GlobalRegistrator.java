 ...
 *
 */
public abstract class GlobalRegistrator extends ObservableRegistrator {
...
////////////////////////////////////////////     
		...
		GlobalFeatureIterator smfi = new GlobalFeatureIterator(source);
		GlobalFeatureIterator tmfi = new GlobalFeatureIterator(target);
		  ...
		  for (int i = minFeature; i <= maxFeature; i++) {
			  ...
			  similarityList.add(new Double(similarity));
				featureList.add(new Integer(1));
				sitSizeList.add(new Integer(smfi.size()));                                                 
